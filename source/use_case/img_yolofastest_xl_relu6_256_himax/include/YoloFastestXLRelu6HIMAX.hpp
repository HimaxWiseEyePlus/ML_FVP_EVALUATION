 ...
 */
#ifndef IMG_YoloFastestXLRelu6HIMAX_HPP
#define IMG_YoloFastestXLRelu6HIMAX_HPP
...
namespace app {
    ...
    class YoloFastestXLRelu6HIMAX : public Model {
    ...
    private:
        ...
        static constexpr int ms_maxOpCnt = 1;//13;
